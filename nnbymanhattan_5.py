...
@date : 2021.11
@description : Nearest Neighbor Algorithm by Manhattan distance (k=5)
"""
...
#test
print('-------5NN by manhattan--------')
knn(draft,[6.75,3.0],5)
knn(draft,[5.34,6.0],5)
knn(draft,[4.67,8.4],5)
knn(draft,[7.0,7.0],5)
knn(draft,[7.8,5.4],5)
